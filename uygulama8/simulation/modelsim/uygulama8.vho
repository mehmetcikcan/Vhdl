...
ARCHITECTURE structure OF uygulama8 IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
SIGNAL \ALT_INV_HEX0~5_combout\ : std_logic;
...
\ALT_INV_HEX0~5_combout\ <= NOT \HEX0~5_combout\;
...
-- Equation(s):
-- \HEX0~0_combout\ = (\SW[2]~input_o\) # ((\SW[0]~input_o\) # (\SW[1]~input_o\ $ (!\SW[3]~input_o\)))
...
-- Equation(s):
-- \HEX0~1_combout\ = (\SW[2]~input_o\ $ (!\SW[3]~input_o\)) # (!\SW[1]~input_o\)
...
-- Equation(s):
-- \HEX0~2_combout\ = (\SW[1]~input_o\) # ((\SW[3]~input_o\) # (!\SW[2]~input_o\))
...
-- Equation(s):
-- \HEX0~3_combout\ = (\SW[0]~input_o\) # ((\SW[1]~input_o\ & (\SW[2]~input_o\ $ (\SW[3]~input_o\))) # (!\SW[1]~input_o\ & ((\SW[2]~input_o\) # (!\SW[3]~input_o\))))
...
-- Equation(s):
-- \HEX0~4_combout\ = (!\SW[3]~input_o\ & ((\SW[2]~input_o\) # (!\SW[1]~input_o\)))
...
-- Equation(s):
-- \HEX0~5_combout\ = (\SW[0]~input_o\) # ((\SW[1]~input_o\ & ((!\SW[3]~input_o\) # (!\SW[2]~input_o\))) # (!\SW[1]~input_o\ & (!\SW[2]~input_o\ & !\SW[3]~input_o\)))
...
-- Equation(s):
-- \HEX0~6_combout\ = (\SW[0]~input_o\) # ((\SW[1]~input_o\ & ((!\SW[3]~input_o\) # (!\SW[2]~input_o\))) # (!\SW[1]~input_o\ & (\SW[2]~input_o\)))
