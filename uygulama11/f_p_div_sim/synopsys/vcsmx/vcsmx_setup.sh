...
TOP_LEVEL_NAME="f_p_div"
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="/home/mehmet/intelFPGA_lite/18.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/f_p_div_memoryC2_uid154_invTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/f_p_div_memoryC1_uid151_invTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/f_p_div_memoryC0_uid147_invTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/f_p_div_memoryC1_uid150_invTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/f_p_div_memoryC0_uid146_invTables_lutmem.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/f_p_div.vo"
fi
